...
Tabs.Home:AddButton({
    ...
    Callback = function()
        ...
        Fluent:Notify({ Title = "Copied", Content = "alchemistslimee", Duration = 2 })
    end
})
...
local speedVal = Tabs.Misc:AddSlider("speedVal", { Title = "Speed (walk)", Default = 50, Min = 16, Max = 250, Rounding = 0 })
